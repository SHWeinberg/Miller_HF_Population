...
function ydot = Model_SignalingMyokit2_Standalone(t,y, c)  % Remove t and pace because they are not used.... 
...
if min(y) < 0
    fprintf('Something is negative that shouldn''t be');
end

if ydot(40) < 0
    ydot =real(ydot); % bandaid fix. I can't figure out the root cause of this issue. 
end
end
