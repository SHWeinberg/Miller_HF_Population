...
%
%
function c = Constants_SignalingMyokit2_HF(iso_conc,Rad_Multiplier,Rb1_Multiplier, Rb2_Multiplier, PKA_Multiplier,PP1_Multiplier, ICaLdp_Multiplier,PDE2_Multiplier)
...
radius = 0.0011*Rad_Multiplier;% Cell radius
...
PKA_tot = 0.5*PKA_Multiplier; % Total cellular concentration of PKA holoenzyme (umol/L)
...
c(24) = c(21) * pka_cav_K3;% Caveolar backw�ard rate for dissociation of C subunit
...
c(35) = 0.1*PP1_Multiplier;% PP1 concentration in the extracaveolar compartment
c(36) = 0.25*PP1_Multiplier;% PP1 concentration in the caveolar compartment
c(37) = 0.2*PP1_Multiplier;% PP1 concentration in the cytosolic compartment

c(38) = 0.001;% Affinity for PP1 Inhibitor 1 binding
...
PDE2_tot = 0.029268*PDE2_Multiplier;% Total cellular concentration of PDE2
...
% beta_cav
c(86) = 1.0;
c(87) = f_Rb1_cav * beta_R_b1_tot * c(5) * Rb1_Multiplier;% Total concentration of beta1AR in the caveolar subspace
c(88) = 1.0;% Ratio of beta2AR incorporated in RGs_Tot and LRGs_Tot
c(89) = f_Rb2_cav * beta_R_b2_tot * c(5) * Rb2_Multiplier;% Total concentration of beta2AR in the caveolar subspace
...
c(97) = f_Rb2_eca * beta_R_b2_tot * c(6) * Rb2_Multiplier;% Total concentration of beta2AR in the extracaveolar space
c(98) = f_Rb1_eca * beta_R_b1_tot * c(6) * Rb1_Multiplier;% Total concentration of beta1AR in the extracaveolar space
...
% beta_cyt
c(104) = f_Rb1_cyt * beta_R_b1_tot * c(7) * Rb1_Multiplier;% Total concentration of beta-1 AR in the cytoplasm
c(105) = 1.0;
...
c(158) = 0.0006903*ICaLdp_Multiplier;      % Rate of ICaL channel dephosphorylation by phosphatases - Scaling rate of dephosphorylation
